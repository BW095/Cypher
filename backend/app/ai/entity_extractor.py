...
from app.config import ExtractionConfig, BedrockConfig
class EntityExtractor:
    def __init__(self):
        # Use the dedicated (cheaper, faster) Bedrock extraction model.
        extraction_model = BedrockConfig.EXTRACTION_MODEL_ID
        print(f"[EntityExtractor] Using Bedrock extraction model: {extraction_model}")
        self.llm = LLMWrapper(model_id=extraction_model)
